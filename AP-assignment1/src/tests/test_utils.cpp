...
TEST(UtilsTest, GetRelevanceGrades) {
    ...
    std::map<int, size_t> relevanceGrades = Utils::GetRelevanceGrades(1, 104, movieToUsers, userToMovies);

    // Expected results
    EXPECT_EQ(relevanceGrades[105], 4) << "Relevance grade for movie 105 is incorrect.";
    EXPECT_EQ(relevanceGrades[106], 3) << "Relevance grade for movie 106 is incorrect.";
    EXPECT_EQ(relevanceGrades[111], 3) << "Relevance grade for movie 111 is incorrect.";
    EXPECT_EQ(relevanceGrades[110], 2) << "Relevance grade for movie 110 is incorrect.";
    EXPECT_EQ(relevanceGrades[113], 2) << "Relevance grade for movie 113 is incorrect.";
    EXPECT_EQ(relevanceGrades[112], 2) << "Relevance grade for movie 112 is incorrect.";
}
